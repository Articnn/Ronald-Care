...
(1, 'CDMX', 'Casa Ronald CDMX', 1, SYSUTCDATETIME()),
(2, 'MTY', 'Casa Ronald Monterrey', 1, SYSUTCDATETIME());
...
(2, 1, 1, 'REF-2026-1002', 'FAM-5520', 'en_revision', '2026-04-03', 1, 'Ingreso vespertino con acompanante unico.', 1, SYSUTCDATETIME());
...
(2, 2, 1, NULL, 'Carlos', 'Ramirez', 'pendiente', 0, 0, NULL, NULL, SYSUTCDATETIME());
...
(3, 1, 1, NULL, 'family', 'Apoyo de recepcion', 'recepcion', 'baja', NULL, 26, 'baja', 'Baja urgencia, 10 min esperando', 'en_proceso', 'staff', 2, 'Recepcion Demo', DATEADD(MINUTE, -10, SYSUTCDATETIME()), DATEADD(MINUTE, -7, SYSUTCDATETIME()), NULL, DATEADD(MINUTE, -10, SYSUTCDATETIME()));
...
(2, 1, 1, NULL, 'Terminal Norte', 'PM', 3, 'Voluntario Demo', 'finalizado', DATEADD(MINUTE, -42, SYSUTCDATETIME()), DATEADD(MINUTE, -4, SYSUTCDATETIME()), 38, DATEADD(HOUR, -3, SYSUTCDATETIME()));
...
(2, 1, NULL, 'Equipo Escolar Norte', 'escolar', 'acompanamiento', '2026-04-02', 'PM', 'cupo_limitado', 3.50, SYSUTCDATETIME()),
(3, 1, NULL, 'Brigada Empresarial Sol', 'empresarial', 'recepcion', '2026-04-03', 'AM', 'disponible', 5.00, SYSUTCDATETIME());
...
(2, 1, 'KIT-HIG', 'Kit higiene', 'pieza', 14, 10, SYSUTCDATETIME()),
(3, 1, 'COBIJA', 'Cobija', 'pieza', 21, 6, SYSUTCDATETIME());
...
(2, 2, 1, 2, 'out', 2, 'Entrega operativa de higiene', DATEADD(HOUR, -4, SYSUTCDATETIME())),
(3, 3, 1, 2, 'in', 5, 'Reposicion semanal de cobijas', DATEADD(DAY, -1, SYSUTCDATETIME()));
...
(2, 1, 'request_resolved', 'request', 2, 'Kit entregado a tiempo', 'Un apoyo de bienvenida se completo dentro del flujo operativo.', 1, DATEADD(MINUTE, -30, SYSUTCDATETIME()));
...
(2, 1, 'Familia Horizonte', 'La consulta asistida en recepcion fue muy rapida cuando no tuvimos bateria.', 'active', 0, SYSUTCDATETIME(), NULL, NULL);
...
(3, 1, 2, NULL, 'request.created', 'request', 1, '{"type":"transporte"}', SYSUTCDATETIME()),
(4, 1, 2, NULL, 'kit.delivered', 'inventory_movement', 1, '{"item":"Kit bienvenida","quantity":1}', SYSUTCDATETIME()),
(5, 1, 3, NULL, 'trip.finished', 'trip', 2, '{"durationMinutes":38}', SYSUTCDATETIME());
